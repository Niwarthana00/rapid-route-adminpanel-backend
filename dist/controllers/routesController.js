...
export const createRoute = async (req, res, next) => {
    try {
        const { routeNumber, name, originHaltId, destinationHaltId, distanceKm, durationMinutes, isActive, halts, } = req.body;
    ...
    `;
        ...
        if (halts && Array.isArray(halts)) {
           ...
           VALUES ($1, $2, $3, $4, $5)
           ON CONFLICT DO NOTHING`, [newRoute.id, h.haltId, h.sequence, h.distanceFromOriginKm || 0, h.etaMinutes || 0]);
            }
        }
    ...
    `;
        ...
        if (halts && Array.isArray(halts)) {
            ...
            for (const h of halts) {
                await query(`INSERT INTO core.route_halts (route_id, halt_id, sequence_order, distance_from_origin_km, travel_time_from_origin_mins)
           VALUES ($1, $2, $3, $4, $5)
           ON CONFLICT DO NOTHING`, [id, h.haltId, h.sequence, h.distanceFromOriginKm || 0, h.etaMinutes || 0]);
            }
        }
