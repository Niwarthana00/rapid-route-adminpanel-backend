...
async function initDatabase() {
    ...
    try {
        ...
        const dbCheck = await adminClient.query(`SELECT 1 FROM pg_database WHERE datname = $1`, [config.db.database]);
    ...
    const targetClient = new pg.Client(config.db.connectionString
